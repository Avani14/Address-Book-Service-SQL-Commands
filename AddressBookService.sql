...
insert into address_book values("Charlotte","Bronte","Colony Address","Delhi","Delhi",445375,8176511212,"charlotte@gmail.com","Family");
...
select count(name) from address_book;
